        ...
        <section class="section">
            ...
            <div class="content">
                ...
                <div class="mainbox">
                    ...
                    <div class="header">
                        <img src="../assets/img/portfolio-header.svg" alt="sell" class="portfolio_icon">
                        ...
                        <thead>
                            <tr class="portfolio_table">
                                ...
                                <th scope="col" class="Company" @click="sortTableByCompany">
                                    <img src="../assets/img/company.svg" alt="buy" class="sorting_icons">
                                    <div>Company</div>
                                </th>
                                <th scope="col" class="Shares" @click="sortTableBySharesBuy">
                                    <img src="../assets/img/shares.svg" alt="buy" class="sorting_icons">
                                    <div>Shares Buy</div>
                                </th>
                                <th scope="col" class="Buy" @click="sortTableByBuy">
                                    <img src="../assets/img/buy.svg" alt="buy" class="sorting_icons">
                                    <div>Buy</div>
                                </th>
                                <th scope="col" class="Sell" @click="sortTableBySell">
                                    <img src="../assets/img/sell.svg" alt="buy" class="sorting_icons">
                                    <div>Sell</div>
                                </th>
                                ...
                                <th scope="col" class="InterestBuySell" @click="sortTableByInterestBuySell">
                                    <img src="../assets/img/interest.svg" alt="buy" class="sorting_icons">
                                    <div>Interest</div>
                                </th>
                                <th scope="col" class="ProfitLossBuySell" @click="sortTableByProfitLossBuySell">
                                    <img src="../assets/img/profit-loss.svg" alt="buy" class="sorting_icons">
                                    <div>Profit/Loss </div>
                                </th>
                                ...
                                <th scope="col" class="Dividend" @click="sortTableByDividend">
                                    <img src="../assets/img/dividend.svg" alt="buy" class="sorting_icons">
                                    <div>Dividend</div>
                                </th>
                            ...
                            <tr v-for="box in paginatedData" :key="box.id" class="desktop_added_form">
                                ...
                                <td class="desktop_edit_remove">
                                    <button class="mobile_edit_remove_button" @click="loadPortfolioForEdit(box.id)">
                                        <img src="../assets/img/edit.svg" alt="sell" class="added_box_icon">
                                    </button>
                                    <button class="mobile_edit_remove_button" @click="deletePortfolioConfirmation(box.id)">
                                        <img src="../assets/img/bin.svg" alt="sell" class="added_box_icon">
                                    </button>
                                </td>
                            </tr>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#" @click="sortTableByCompany">
                                                <img src="../assets/img/company.svg" alt="buy" class="sorting_mobile_icon">
                                                Company
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" @click="sortTableBySharesBuy">
                                                <img src="../assets/img/shares.svg" alt="buy" class="sorting_mobile_icon">
                                                Shares Buy
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" @click="sortTableByBuy">
                                                <img src="../assets/img/buy.svg" alt="buy" class="sorting_mobile_icon">
                                                Buy
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" @click="sortTableBySell">
                                                <img src="../assets/img/sell.svg" alt="buy" class="sorting_mobile_icon">
                                                Sell
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="#" @click="sortTableByInterestBuySell">
                                                <img src="../assets/img/interest.svg" alt="buy" class="sorting_mobile_icon">
                                                Interest - Buy/Sell
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" @click="sortTableByProfitLossBuySell">
                                                <img src="../assets/img/profit-loss.svg" alt="buy" class="sorting_mobile_icon">
                                                Profit/Loss - Buy/Sell
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" @click="sortTableByDividend">
                                                <img src="../assets/img/dividend.svg" alt="buy" class="sorting_mobile_icon">
                                                Dividend
                                            </a>
                                        </li>
                                        <li>
                    ...
                    <table v-if="!loading" class="mobile_portfolio_table">
                        ...
                        <tr v-for="sumBox in sumBoxes" :key="sumBox.id" class="mobile_added_form_sum">
                            ...
                            <td class="mobile_buy_sum_box">
                                <div class="name">
                                    <img src="../assets/img/buy.svg" alt="buy" class="added_box_icon">
                                    <div>Buy</div>
                                </div>
                                <div class="value">
                            ...
                            <td class="mobile_sell_sum_box">
                                <div class="name">
                                    <img src="../assets/img/sell.svg" alt="sell" class="added_box_icon">
                                    <div>Sell</div>
                                </div>
                                <div class="value">
                            ...
                            <td class="mobile_interestBuySell_sum_box">
                                <div class="name">
                                    <img src="../assets/img/interest.svg" alt="sell" class="added_box_icon">
                            ...
                            <td class="mobile_profitLossBuySell_sum_box">
                                <div class="name">
                                    <img src="../assets/img/profit-loss.svg" alt="sell" class="added_box_icon">
                            ...
                            <td class="mobile_dividend_sum_box">
                                <div class="name">
                                    <img src="../assets/img/dividend.svg" alt="sell" class="added_box_icon">
                                    <div>Dividend</div>
                                </div>
                                <div class="value">
                        ...
                        <tr v-for="box in paginatedData" :key="box.id" class="mobile_added_form">
                            ...
                            <td class="mobile_shares_box">
                                <div class="name">
                                    <img src="../assets/img/shares.svg" alt="sell" class="added_box_icon">
                                    <div>Shares Buy</div>
                                </div>
                                <div class="value">
                            ...
                            <td class="mobile_buy_box">
                                <div class="name">
                                    <img src="../assets/img/buy.svg" alt="sell" class="added_box_icon">
                                    <div>Buy</div>
                                </div>
                                <div class="value">
                    ...
                    <div class="bot">
                        ...
                        <button @click="showAddForm = true" v-if="!showAddForm" class="bot_box">
                            ...
                            <div class="bot_box_icon">
                                <img src="../assets/img/plus.svg" alt="sell" class="bot_icon">
                            </div>
...
.Buy:hover,
.Sell:hover,
.InterestBuySell:hover,
.ProfitLossBuySell:hover,
.Dividend:hover,
